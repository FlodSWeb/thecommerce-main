        ...
        <Row>
          <Col length={12}>
            <div className="title">
              ...
              <p>
                <i>
                  Venez découvrir notre boutique en ligne, tous nos thé sont
                  d'origine bio
                </i>
              </p>
            </div>
          ...
          {products.map((product, i) => {
            return (
              <Col length={4} key={i}>
                <Box
                  class={"cart"}
                  handleClick={(event) => handleDetail(event, product)}
                >
                  ...
                  <div className="cart-item">
                    <ul>
                      ...
                      <li>
                        Disponible: {product.quantity >= 1 ? "oui" : "non"}
                      </li>
                    </ul>
                  </div>
                  <div className="action">
                    <ButtonPrimary
                      type={"button"}
                      handleClick={() => console.log("detail")}
                    >
                      Ajouter
                    </ButtonPrimary>
                  </div>
